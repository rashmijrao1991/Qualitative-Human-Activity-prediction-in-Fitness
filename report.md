...
![Correlation Matrix](/Images/Corrmat.png)
    ...
    # Removeing the highly correlated variables from both training and test data
...
![Decision Tree Plot](/Images/decisionTree.png)
...
![Accuracy and Gini scores](/Images/AccNGini.png)
